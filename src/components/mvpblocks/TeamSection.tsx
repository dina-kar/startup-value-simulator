...
export function TeamSection({
  ...
  members = [
    ...
    { name: "Alex R.", role: "Product", blurb: "Simplifying complex cap table math." },
    { name: "Priya S.", role: "Design", blurb: "Crafting clarity-first UI." },
  ],
}: TeamSectionProps) {
  return (
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {members.map((m, i) => (
            <motion.div
              ...
              className="relative rounded-xl border border-border/50 bg-muted/40 dark:bg-background/50 p-6 text-center backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow"
            >
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 text-lg font-semibold text-white">
                {m.avatar ? (
